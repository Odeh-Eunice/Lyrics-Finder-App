        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "h1",
                    null,
                    "Lyrics-2: Poor Man's Genius"
                ),
                _react2.default.createElement(
                    "form",
                    { action: "#", onSubmit: this.handleSubmit.bind(this), className: "form-inline" },
                    _react2.default.createElement(
                        "div",
                        { className: "form-group" },
                        _react2.default.createElement("label", { htmlFor: "query" }),
                        _react2.default.createElement("input", { type: "text", name: "query", id: "query", placeholder: "Search Songs & Artists" }),
                        _react2.default.createElement(
                            "button",
                            { className: "btn" },
...
},{"react":"../node_modules/react/index.js","react-router-dom":"../node_modules/react-router-dom/es/index.js"}],"components/routes/Results.jsx":[function(require,module,exports) {
'use strict';
...
var Results = function (_Component) {
    ...
    _createClass(Results, [{
        ...
        value: function getResults() {
            ...
            fetch('/search/' + this.props.query).then(function (res) {
                return res.json();
            }).then(function (data) {
                console.log(data);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'ul',
                    null,
                    this.state.results.map(function (hit, index) {
                        return _react2.default.createElement(
                            _reactRouterDom.Link,
                            { key: index, to: '/song/' + hit.song_id },
                            _react2.default.createElement(
                                'li',
                                { className: 'result' },
                                _react2.default.createElement('img', { src: hit.song_art, alt: 'song art', className: 'result-thumbnail' }),
                                _react2.default.createElement(
                                    'p',
...
},{"react":"../node_modules/react/index.js","react-router-dom":"../node_modules/react-router-dom/es/index.js"}],"components/Lyrics.jsx":[function(require,module,exports) {
"use strict";
...
var Lyrics = function Lyrics(props) {
    return _react2.default.createElement(
        ...
        props.lyrics.split("\n").map(function (chunk, index) {
            return _react2.default.createElement(
                "div",
                { key: index, className: "lyric-chunk" },
                chunk,
                " ",
                _react2.default.createElement("br", null)
            );
...
},{"react":"../node_modules/react/index.js"}],"components/SongInfo.jsx":[function(require,module,exports) {
'use strict';
...
var SongInfo = function SongInfo(props) {
    var metaData = props.metaData;
    var primary_artist = metaData.primary_artist,
        featured_artists = metaData.featured_artists,
        producer_artists = metaData.producer_artists,
        album = metaData.album,
        title = metaData.title,
        song_art_image_url = metaData.song_art_image_url;

    var album_art = !album ? song_art_image_url : album.cover_art_url;
    var images = [album_art, song_art_image_url];
    return _react2.default.createElement(
        'div',
        { className: 'songInfo-container', style: { backgroundImage: 'url(' + images[0] + ')' } },
        _react2.default.createElement(
            'div',
            { className: 'content' },
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    featured_artists.length > 0 ? _react2.default.createElement(
                        'h6',
                        null,
                        'Featuring ',
                        featured_artists.map(function (artist, idx) {
                    ...
                    producer_artists.length > 0 ? _react2.default.createElement(
                        'h6',
                        null,
                        'Produced by ',
                        producer_artists.map(function (artist, idx) {
...
},{"react":"../node_modules/react/index.js","react-router-dom":"../node_modules/react-router-dom/es/index.js"}],"components/routes/SongPage.jsx":[function(require,module,exports) {
'use strict';
...
var SongPage = function (_Component) {
    ...
    function SongPage(props) {
        ...
        _this.getLyrics = _this.getLyrics.bind(_this);
        return _this;
    }
    ...
    _createClass(SongPage, [{
        ...
        key: 'getSongInfo',
        value: function getSongInfo(callback) {
            var _this2 = this;

            var id = this.props.id;
            fetch("/song/" + id).then(function (res) {
                return res.json();
            }).then(function (data) {
                console.log(data);
                _this2.setState({ songData: data });
            }).then(function () {
                return callback();
            });
        }
        ...
        key: 'getLyrics',
        value: function getLyrics(callback) {
            var _this3 = this;

            var path = this.state.songData.path;
            fetch("/lyrics" + path).then(function (res) {
                return res.json();
            }).then(function (data) {
                _this3.setState({ lyrics: data, doneLoading: true });
            }).then(function () {
                if (callback) {
                    callback();
                }
        ...
        key: 'findYoutubeVideo',
        value: function findYoutubeVideo() {
            var media = this.state.songData.media;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                !this.state.doneLoading ? _react2.default.createElement(
                    'h1',
                    ...
                    _react2.default.createElement(_Lyrics2.default, { lyrics: this.state.lyrics })
                )
            );
        }
    }]);
...
},{"react":"../node_modules/react/index.js","react-router-dom":"../node_modules/react-router-dom/es/index.js","../Lyrics":"components/Lyrics.jsx","../SongInfo":"components/SongInfo.jsx"}],"components/Routes.jsx":[function(require,module,exports) {
'use strict';
...
var _Results = require('./routes/Results');

var _Results2 = _interopRequireDefault(_Results);

var _SongPage = require('./routes/SongPage');
    ...
    _createClass(Routes, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_reactRouterDom.Route, { path: '/search/:query', render: function render(props) {
                        var query = props.match.params.query;

                        return _react2.default.createElement(_Results2.default, { query: query });
                    } }),
                _react2.default.createElement(_reactRouterDom.Route, { path: '/song/:songId', render: function render(props) {
                        var songId = props.match.params.songId;

                        console.log(songId);
                        return _react2.default.createElement(_SongPage2.default, { id: songId });
                    } })
            );
        }
    }]);
...
},{"react":"../node_modules/react/index.js","react-router-dom":"../node_modules/react-router-dom/es/index.js","./routes/Results":"components/routes/Results.jsx","./routes/SongPage":"components/routes/SongPage.jsx"}],"components/App.jsx":[function(require,module,exports) {
'use strict';
...
exports.default = App;
},{"react":"../node_modules/react/index.js","./SearchBar":"components/SearchBar.jsx","./Routes":"components/Routes.jsx"}],"index.js":[function(require,module,exports) {
'use strict';
...
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","react-router-dom":"../node_modules/react-router-dom/es/index.js","./components/App":"components/App.jsx"}],"../node_modules/parcel-bundler/lib/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/client.104d0b15.map